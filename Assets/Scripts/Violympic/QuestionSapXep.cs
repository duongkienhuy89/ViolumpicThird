...
public class QuestionSapXep : MonoBehaviour {
    ...
    public void Create()
    {
        ...
        else if (GameController.instance.level == 5)
        {
            ...
            var bien = GameController.instance.lstNhan67.Concat(GameController.instance.lstNhan89).Concat(ClsThaoTac.FakeData(70, 80)).ToList();
            chonData(ref lstTMG, bien, GameController.instance.level);
        }
        else if (GameController.instance.level == 6)
        {
            var bien = GameController.instance.lstNhan1011.Concat(ClsThaoTac.FakeData(90, 100)).ToList();
            chonData(ref lstTMG, bien, GameController.instance.level);
        }
        ...
        else if (GameController.instance.level == 9)
        {
            ...
            chonData(ref lstTMG, GameController.instance.lstNhan5199, GameController.instance.level);
        }
        ...
        else if (GameController.instance.level == 11)
        {
            ...
            var bien = GameController.instance.lstChia67.Concat(GameController.instance.lstChia1150).ToList();
            chonData(ref lstTMG, bien, GameController.instance.level);
        }
        else if (GameController.instance.level == 12)
        {

            var bien = GameController.instance.lstChia89.Concat(GameController.instance.lstChia51150).ToList();
            chonData(ref lstTMG, bien, GameController.instance.level);
        }
        ...
        else if (GameController.instance.level == 14 || GameController.instance.level == 15)
        {
